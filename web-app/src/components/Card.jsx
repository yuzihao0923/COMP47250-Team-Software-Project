...
export default function Card(props) {
    ...
    return (
        <div className='flex h-36 hover:shadow-lg transition duration-300 ease-in-out'>
            <div className={`flex items-center justify-center ${logoBackground} w-1/4 rounded-l-lg`}>
                <span>
                    {logo}
                </span>
            </div>
            <div className='bg-fuchsia-100 flex flex-1 flex-col justify-center items-center text-center rounded-r-lg'>
